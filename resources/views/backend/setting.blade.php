                ...
                <div class="input-group">
                    <div class="input-group-btn">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="javascript:void(0)" onClick="document.getElementById('url_callback_bot').value='{{url('')}}'">Put Url</a>
                            <a class="dropdown-item" href="javascript:void(0)" onClick="event.preventDefault();document.getElementById('setwebhook').submit()">Send Url </a>
                            <a class="dropdown-item" href="javascript:void(0)" onClick="event.preventDefault();document.getElementById('getwebhookinfo').submit()">Get Info</a>
                        </div>
                    </div>
