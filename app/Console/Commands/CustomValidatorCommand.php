...
class CustomValidatorCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $description = 'Create trait Validator';
    ...
    {
        return $rootNamespace . '\Validator';
    }
