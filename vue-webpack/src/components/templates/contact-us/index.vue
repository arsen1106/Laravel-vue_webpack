<template>
  ...
  <div class="wrap-contact100 w-100 mt-4">
    <button class="contact100-btn-hide">
      <i class="fa fa-close" aria-hidden="true"></i>
    </button>

    <form class="contact100-form validate-form" method="POST" autocomplete="off" @submit.prevent="create" v-if="!success">
				<span class="contact100-form-title">
					Contact Us
				</span>
      <div class="text-center">
        <span class="text-danger" v-if="error" role="alert"><strong>{{ errorMessage }}</strong></span>
      </div>
...
<script>
    export default {
      ...
      methods:{
        create:function(){
          this.axios.post('notification/new-contact-us',this.model)
          .then((response)=>{
