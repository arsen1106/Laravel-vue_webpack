                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-auto mb-3">
                                            <div class="mx-auto" style="width: 140px;">
                                                <div :style=" error && errors.cover_photo ? 'border: 1px solid red;' : 'border: none;' " class="d-flex justify-content-center align-items-center rounded" style="height: 140px; background-color: rgb(233, 236, 239);">
                                                    <span
                                                      v-show="photoHide && model.newRecord"
                                                      class="text-center"
                                        ...
                                        <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                                            ...
                                            <div class="text-center text-sm-right">
                                                ...
                                                <div
                                                  v-if="!model.newRecord"
                                                  class="text-muted"
                                                >
                                                  <small>Joined {{ getJoinedDate }}</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input
                                                                      id="surname"
                                                                      type="text"
                                                                      :class="['form-control', { 'is-invalid': error && errors.surname }]"
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input
                                                                      id="phone"
                                                                      type="text"
                                                                      :class="['form-control', { 'is-invalid': error && errors.phone }]"
                                                                      v-model="model.phone"
                                                                      autocomplete="phone"
                                                                    />
                                                                    <span
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <div class="custom-controls-stacked px-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input
                                                                          type="radio"
                                                                          :checked="!model.status || model.status === 1"
                                                                          class="custom-control-input"
                                                                          id="user-status-approved"
                                                                          value="1"
                                                                          name="status"
                                                                          @input="model.status = $event.target.value"
                                                                        />
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <div class="custom-controls-stacked px-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input
                                                                          type="radio"
                                                                          :checked="!model.gender || model.gender === 1"
                                                                          class="custom-control-input"
                                                                          id="user-gender-male"
                                                                          value="1"
                                                                          name="gender"
                                                                          @input="model.gender = $event.target.value"
                                                                        />
